 ...
 *
 *  Copyright (c) 2013 MITRE corporation.
 */


#include "modules/audio_device/android/audio_device_svmp.h"
...
#define WEBRTC_OPENSL_TRACE(a, b, c, ...)                               \
  __android_log_print(ANDROID_LOG_DEBUG, "WebRTC SVMP_Audio", __VA_ARGS__)
#else
...
AudioDeviceAndroidSVMP::AudioDeviceAndroidSVMP(const int32_t id)
...
AudioDeviceAndroidSVMP::~AudioDeviceAndroidSVMP() {
...
void AudioDeviceAndroidSVMP::AttachAudioBuffer(
...
int32_t AudioDeviceAndroidSVMP::ActiveAudioLayer(
...
int32_t AudioDeviceAndroidSVMP::Init() {
  CriticalSectionScoped lock(&crit_sect_);
...
int32_t AudioDeviceAndroidSVMP::Terminate() {
  CriticalSectionScoped lock(&crit_sect_);
...
bool AudioDeviceAndroidSVMP::Initialized() const {
  return (is_initialized_);
}

int32_t AudioDeviceAndroidSVMP::SpeakerIsAvailable(
    bool& available) {
...
int32_t AudioDeviceAndroidSVMP::InitSpeaker() {
  CriticalSectionScoped lock(&crit_sect_);
...
int32_t AudioDeviceAndroidSVMP::MicrophoneIsAvailable(
    bool& available) {
  // We always assume it's available.
  available = true;
  return 0;
...
int32_t AudioDeviceAndroidSVMP::InitMicrophone() {
  CriticalSectionScoped lock(&crit_sect_);
  if (is_recording_) {
    WEBRTC_OPENSL_TRACE(kTraceWarning, kTraceAudioDevice, id_,
...
bool AudioDeviceAndroidSVMP::SpeakerIsInitialized() const {
  return is_speaker_initialized_;
}

bool AudioDeviceAndroidSVMP::MicrophoneIsInitialized() const {
  return is_mic_initialized_;
}

int32_t AudioDeviceAndroidSVMP::SpeakerVolumeIsAvailable(
    bool& available) {
  available = true;  // We assume we are always be able to set/get volume.
  return 0;
}

int32_t AudioDeviceAndroidSVMP::SetSpeakerVolume(
    uint32_t volume) {
...
int32_t AudioDeviceAndroidSVMP::SpeakerVolume(
    uint32_t& volume) const {
  return 0;
}

int32_t AudioDeviceAndroidSVMP::SetWaveOutVolume(
    uint16_t volumeLeft,
...
int32_t AudioDeviceAndroidSVMP::WaveOutVolume(
    uint16_t& volumeLeft,
...
int32_t AudioDeviceAndroidSVMP::MaxSpeakerVolume(
...
int32_t AudioDeviceAndroidSVMP::MinSpeakerVolume(
...
int32_t AudioDeviceAndroidSVMP::SpeakerVolumeStepSize(
...
int32_t AudioDeviceAndroidSVMP::SpeakerMuteIsAvailable(
    bool& available) {
  available = false;  // Speaker mute not supported on Android.
  return 0;
}

int32_t AudioDeviceAndroidSVMP::SetSpeakerMute(bool enable) {
  WEBRTC_OPENSL_TRACE(kTraceWarning, kTraceAudioDevice, id_,
                      "  API call not supported on this platform");
  return -1;
}

int32_t AudioDeviceAndroidSVMP::SpeakerMute(
    bool& enabled) const {
  WEBRTC_OPENSL_TRACE(kTraceWarning, kTraceAudioDevice, id_,
                      "  API call not supported on this platform");
  return -1;
...
int32_t AudioDeviceAndroidSVMP::MicrophoneMuteIsAvailable(
    bool& available) {
  available = false;  // Mic mute not supported on Android
  return 0;
}

int32_t AudioDeviceAndroidSVMP::SetMicrophoneMute(bool enable) {
  WEBRTC_OPENSL_TRACE(kTraceWarning, kTraceAudioDevice, id_,
               "  API call not supported on this platform");
  return -1;
}

int32_t AudioDeviceAndroidSVMP::MicrophoneMute(
    bool& enabled) const {
  WEBRTC_OPENSL_TRACE(kTraceWarning, kTraceAudioDevice, id_,
               "  API call not supported on this platform");
  return -1;
...
int32_t AudioDeviceAndroidSVMP::MicrophoneBoostIsAvailable(
    bool& available) {
  available = false;  // Mic boost not supported on Android.
  return 0;
}

int32_t AudioDeviceAndroidSVMP::SetMicrophoneBoost(bool enable) {
...
int32_t AudioDeviceAndroidSVMP::MicrophoneBoost(
    bool& enabled) const {
  if (!is_mic_initialized_) {
    WEBRTC_OPENSL_TRACE(kTraceError, kTraceAudioDevice, id_,
                 "  Microphone not initialized");
...
int32_t AudioDeviceAndroidSVMP::StereoRecordingIsAvailable(
    bool& available) {
  available = false;  // Stereo recording not supported on Android.
  return 0;
}

int32_t AudioDeviceAndroidSVMP::SetStereoRecording(bool enable) {
  if (enable) {
    WEBRTC_OPENSL_TRACE(kTraceError, kTraceAudioDevice, id_,
                 "  Enabling not available");
    return -1;
...
int32_t AudioDeviceAndroidSVMP::StereoRecording(
    bool& enabled) const {
  enabled = false;
  return 0;
}

int32_t AudioDeviceAndroidSVMP::StereoPlayoutIsAvailable(
    bool& available) {
...
int32_t AudioDeviceAndroidSVMP::SetStereoPlayout(bool enable) {
  if (enable) {
    return 0;
  } else {
...
int32_t AudioDeviceAndroidSVMP::StereoPlayout(
    bool& enabled) const {
...
int32_t AudioDeviceAndroidSVMP::SetAGC(bool enable) {
  agc_enabled_ = enable;
  return 0;
}

bool AudioDeviceAndroidSVMP::AGC() const {
  return agc_enabled_;
}

int32_t AudioDeviceAndroidSVMP::MicrophoneVolumeIsAvailable(
    bool& available) {
  available = true;
  return 0;
}

int32_t AudioDeviceAndroidSVMP::SetMicrophoneVolume(
    uint32_t volume) {
  WEBRTC_OPENSL_TRACE(kTraceWarning, kTraceAudioDevice, id_,
...
int32_t AudioDeviceAndroidSVMP::MicrophoneVolume(
    uint32_t& volume) const {
  return -1;
}

int32_t AudioDeviceAndroidSVMP::MaxMicrophoneVolume(
    uint32_t& maxVolume) const {
  return 0;
}

int32_t AudioDeviceAndroidSVMP::MinMicrophoneVolume(
    uint32_t& minVolume) const {
  minVolume = 0;
  return 0;
}

int32_t AudioDeviceAndroidSVMP::MicrophoneVolumeStepSize(
    uint16_t& stepSize) const {
  stepSize = 1;
  return 0;
}

int16_t AudioDeviceAndroidSVMP::PlayoutDevices() {
  return 1;
}

int32_t AudioDeviceAndroidSVMP::SetPlayoutDevice(
    uint16_t index) {
...
int32_t AudioDeviceAndroidSVMP::PlayoutDeviceName(
    uint16_t index,
...
int32_t AudioDeviceAndroidSVMP::RecordingDeviceName(
    uint16_t index,
    char name[kAdmMaxDeviceNameSize],
    char guid[kAdmMaxGuidSize]) {
  if (0 != index) {
...
int16_t AudioDeviceAndroidSVMP::RecordingDevices() {
  return 1;
}

int32_t AudioDeviceAndroidSVMP::SetRecordingDevice(
    uint16_t index) {
...
int32_t AudioDeviceAndroidSVMP::PlayoutIsAvailable(
    bool& available) {
  available = false;
...
int32_t AudioDeviceAndroidSVMP::RecordingIsAvailable(
    bool& available) {
  available = false;
...
int32_t AudioDeviceAndroidSVMP::InitPlayout() {
  CriticalSectionScoped lock(&crit_sect_);
  if (!is_initialized_) {
    WEBRTC_OPENSL_TRACE(kTraceError, kTraceAudioDevice, id_,
                        "  Not initialized");
...
int32_t AudioDeviceAndroidSVMP::InitRecording() {
  CriticalSectionScoped lock(&crit_sect_);
...
int32_t AudioDeviceAndroidSVMP::StartRecording() {
  CriticalSectionScoped lock(&crit_sect_);
...
int32_t AudioDeviceAndroidSVMP::StopRecording() {
  {
    CriticalSectionScoped lock(&crit_sect_);
...
bool AudioDeviceAndroidSVMP::RecordingIsInitialized() const {
  return is_rec_initialized_;
}

bool AudioDeviceAndroidSVMP::Recording() const {
  return is_recording_;
}

bool AudioDeviceAndroidSVMP::PlayoutIsInitialized() const {
  return is_play_initialized_;
}

int32_t AudioDeviceAndroidSVMP::StartPlayout() {
  int i;
  CriticalSectionScoped lock(&crit_sect_);
...
int32_t AudioDeviceAndroidSVMP::StopPlayout() {
...
int32_t AudioDeviceAndroidSVMP::PlayoutDelay(
    uint16_t& delayMS) const {
  delayMS = playout_delay_;
  return 0;
}

int32_t AudioDeviceAndroidSVMP::RecordingDelay(
    uint16_t& delayMS) const {
  delayMS = recording_delay_;
  return 0;
}

bool AudioDeviceAndroidSVMP::Playing() const {
  return is_playing_;
}

int32_t AudioDeviceAndroidSVMP::SetPlayoutBuffer(
...
int32_t AudioDeviceAndroidSVMP::PlayoutBuffer(
...
int32_t AudioDeviceAndroidSVMP::CPULoad(
    uint16_t& load) const {
  WEBRTC_OPENSL_TRACE(kTraceWarning, kTraceAudioDevice, id_,
                      "  API call not supported on this platform");
  return -1;
...
bool AudioDeviceAndroidSVMP::PlayoutWarning() const {
  return (play_warning_ > 0);
}

bool AudioDeviceAndroidSVMP::PlayoutError() const {
  return (play_error_ > 0);
}

bool AudioDeviceAndroidSVMP::RecordingWarning() const {
  return (rec_warning_ > 0);
}

bool AudioDeviceAndroidSVMP::RecordingError() const {
  return (rec_error_ > 0);
}

void AudioDeviceAndroidSVMP::ClearPlayoutWarning() {
  play_warning_ = 0;
}

void AudioDeviceAndroidSVMP::ClearPlayoutError() {
  play_error_ = 0;
}

void AudioDeviceAndroidSVMP::ClearRecordingWarning() {
  rec_warning_ = 0;
}

void AudioDeviceAndroidSVMP::ClearRecordingError() {
  rec_error_ = 0;
}

int32_t AudioDeviceAndroidSVMP::SetLoudspeakerStatus(bool enable) {
  loundspeaker_on_ = enable;
  return 0;
}

int32_t AudioDeviceAndroidSVMP::GetLoudspeakerStatus(
    bool& enabled) const {
  enabled = loundspeaker_on_;
  return 0;
}

void AudioDeviceAndroidSVMP::PlayerSimpleBufferQueueCallback(
    SLAndroidSimpleBufferQueueItf queue_itf,
    void* p_context) {
  AudioDeviceAndroidSVMP* audio_device =
      static_cast<AudioDeviceAndroidSVMP*> (p_context);
  audio_device->PlayerSimpleBufferQueueCallbackHandler(queue_itf);
}

void AudioDeviceAndroidSVMP::PlayerSimpleBufferQueueCallbackHandler(
    SLAndroidSimpleBufferQueueItf queue_itf) {
  if (is_playing_) {
...
bool AudioDeviceAndroidSVMP::RecThreadFunc(void* context) {
  return (static_cast<AudioDeviceAndroidSVMP*>(
      context)->RecThreadFuncImpl());
}

void AudioDeviceAndroidSVMP::RecorderSimpleBufferQueueCallback(
    SLAndroidSimpleBufferQueueItf queue_itf,
    void* p_context) {
  AudioDeviceAndroidSVMP* audio_device =
      static_cast<AudioDeviceAndroidSVMP*>(p_context);
...
bool AudioDeviceAndroidSVMP::RecThreadFuncImpl() {
  if (is_recording_) {
...
void AudioDeviceAndroidSVMP::RecorderSimpleBufferQueueCallbackHandler(
    SLAndroidSimpleBufferQueueItf queue_itf) {
  if (is_recording_) {
    const unsigned int num_samples = mic_sampling_rate_ / 100;
    const unsigned int num_bytes =
...
void AudioDeviceAndroidSVMP::CheckErr(SLresult res) {
  if (res != SL_RESULT_SUCCESS) {
    WEBRTC_OPENSL_TRACE(kTraceError, kTraceAudioDevice, id_,
                        "  AudioDeviceAndroidSVMP::CheckErr(%d)", res);
    exit(-1);
  }
}

void AudioDeviceAndroidSVMP::UpdatePlayoutDelay(
...
void AudioDeviceAndroidSVMP::UpdateRecordingDelay() {
  // TODO(leozwang): Add accurate delay estimat.
  recording_delay_ = 10;
...
int32_t AudioDeviceAndroidSVMP::InitSampleRate() {
  if (sles_engine_ == NULL) {
    WEBRTC_OPENSL_TRACE(kTraceError, kTraceAudioDevice, id_,
                        "  SL Object is NULL");
    return -1;
