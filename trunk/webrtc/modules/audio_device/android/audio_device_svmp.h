 ...
 *
 *  Copyright MITRE Corporation 2013.
 */

#ifndef SRC_MODULES_AUDIO_DEVICE_ANDROID_AUDIO_DEVICE_SVMP_H_
#define SRC_MODULES_AUDIO_DEVICE_ANDROID_AUDIO_DEVICE_SVMP_H_
...
class AudioDeviceAndroidSVMP: public AudioDeviceGeneric {
 public:
  explicit AudioDeviceAndroidSVMP(const int32_t id);
  ~AudioDeviceAndroidSVMP();
