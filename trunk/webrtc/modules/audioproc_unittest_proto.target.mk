...
$(builddir)/pyproto/webrtc/audio_processing/unittest_pb2.py: webrtc/modules/audio_processing/test/unittest.proto tools/protoc_wrapper/protoc_wrapper.py $(builddir)/protoc FORCE_DO_CMD
...
cmd_trunk_webrtc_modules_modules_gyp_audioproc_unittest_proto_target_genproto_0 = LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; export LD_LIBRARY_PATH; cd webrtc/modules; mkdir -p $(obj)/gen/protoc_out/webrtc/audio_processing $(builddir)/pyproto/webrtc/audio_processing; python ../../tools/protoc_wrapper/protoc_wrapper.py --include "" --protobuf "$(obj)/gen/protoc_out/webrtc/audio_processing/unittest.pb.h" --proto-in-dir audio_processing/test --proto-in-file "unittest$(suffix $<)" "--use-system-protobuf=0" -- "$(builddir)/protoc" --cpp_out "$(obj)/gen/protoc_out/webrtc/audio_processing" --python_out "$(builddir)/pyproto/webrtc/audio_processing"
