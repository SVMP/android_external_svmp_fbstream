...
OBJS := \
	...
	$(obj).target/$(TARGET)/webrtc/modules/audio_processing/ns/noise_suppression.o \
	$(obj).target/$(TARGET)/webrtc/modules/audio_processing/ns/ns_core.o

# Add to the list of files we specially track dependencies for.
all_deps += $(OBJS)

# Make sure our dependencies are built before any of us.
$(OBJS): | $(obj).target/webrtc/modules/libaudioproc_debug_proto.a
