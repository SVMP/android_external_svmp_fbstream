...
//    result = RunSpecialTestCase(8,&argc,&argv);
//  } else {
//    // Run in interactive mode.
//    result = RunInteractiveMode(&argc, &argv);
//  }
//
//  ViETest::Terminate();
  return result;
...
int ViEAutoTestMain::RunSpecialTestCase(int choice, int *argc, char ***argv) {
 ...
 /*
  ...
  ViEAutoTest vieAutoTest(NULL,NULL);


  int errors = 0;
  switch (choice) {
    case 7: errors = vieAutoTest.ViELoopbackCall(argc,argv);  break;
...
int ViEAutoTestMain::RunInteractiveMode(int *argc, char ***argv) {
  ViETest::Log(" ============================== ");
 ...
 /* int choice = 0;
  ...
  int errors = RunSpecialTestCase(7,argc,argv);
